...
})({"a0kEV":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "9222bbb65b55983b";
"use strict";
...
},{}],"cRUma":[function(require,module,exports) {
(()=>{
    // mini/validTags.js
    var validTags = {
        a: [
    ...
    var render = (vdom, parent)=>{
        ...
        } else if (type == "fragment") children?.map((child)=>{
            render(child, parent);
        });
    };
    ...
    var useState = (initialValue)=>{
        ...
        index++;
        return (()=>{
            if (stateList[idx] === void 0) stateList[idx] = {
                value: initialValue
            };
            const setState = (newValue)=>{
                ...
                Mini.refresh(pathname ? main_default[pathname] : main_default[""], document.getElementById("mini"));
            };
            const getState = ()=>{
    ...
    var Home2 = ()=>{
        ...
        return /* @__PURE__ */ mini_default.createElement("div", {
            style: {
                backgroundColor: "red"
            }
        }, /* @__PURE__ */ mini_default.createElement("h2", null, "A::", getB), /* @__PURE__ */ mini_default.createElement("button", {
            onclick: handle
        }, "clique me A"));
    };
    var Home = ()=>{
        ...
        return /* @__PURE__ */ mini_default.createElement("div", null, /* @__PURE__ */ mini_default.createElement("h2", null, "A: ", getA), /* @__PURE__ */ mini_default.createElement("button", {
            onclick: handle
        }, "clique me A"), /* @__PURE__ */ mini_default.createElement(Home2, null));
    };
    ...
    var List = ()=>{
        ...
        return /* @__PURE__ */ mini_default.createElement("div", null, /* @__PURE__ */ mini_default.createElement("h1", null, "hello it's ", name), /* @__PURE__ */ mini_default.createElement("input", {
            onchange: handle
        }), /* @__PURE__ */ mini_default.createElement("button", null, "clique me button"), /* @__PURE__ */ mini_default.createElement("a", {
...
},{}]},["a0kEV","cRUma"], "cRUma", "parcelRequire8e86")

//# sourceMappingURL=index.5b55983b.js.map
