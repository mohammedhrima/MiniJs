(() => {
  ...
  var Home = () => {
    ...
    return /* @__PURE__ */ lib_default.createElement("div", { className: "test" }, /* @__PURE__ */ lib_default.createElement("h1", null, "Value: ", x), /* @__PURE__ */ lib_default.createElement("button", { onclick: (e) => handle(e) }, "clique me A"));
  };
