(() => {
  ...
  var useState = (initialValue) => {
    ...
    return (() => {
      ...
      const setState = (newValue) => {
        ...
        let { pathname: pathname2 } = window.location;
        pathname2 = pathname2.slice(1);
        Mini.refresh(
          pathname2 ? main_default[pathname2] : main_default[""],
  ...
  var Home2 = () => {
    ...
    return /* @__PURE__ */ mini_default.createElement(
      ...
      /* @__PURE__ */ mini_default.createElement("h2", null, "A: ", getB),
      /* @__PURE__ */ mini_default.createElement(
        "button",
        { onclick: handle },
        "clique me A"
      )
  ...
  var Home = () => {
    ...
    return /* @__PURE__ */ mini_default.createElement(
      "div",
      null,
      /* @__PURE__ */ mini_default.createElement("h2", null, "A: ", getA),
      /* @__PURE__ */ mini_default.createElement(
        "button",
        { onclick: handle },
        "clique me A"
      ),
      /* @__PURE__ */ mini_default.createElement(Home2, null)
    );
  };
  ...
  var List = () => {
    ...
    return /* @__PURE__ */ mini_default.createElement(
      ...
      /* @__PURE__ */ mini_default.createElement("input", { onchange: handle }),
      /* @__PURE__ */ mini_default.createElement(
        "button",
        null,
        "clique me button"
  ...
  var SayHi = ({ name }) => {
    ...
    return /* @__PURE__ */ mini_default.createElement(
      mini_default.Fragment,
      null,
      /* @__PURE__ */ mini_default.createElement("h3", null, "SayHi ", name)
    );
  };
